...
namespace csLTDMC //命名空间根据应用程序修改
{
    public class LTDMC
    {
	 ...
	 [DllImport("LTDMC.dll", EntryPoint = "dmc_read_cmp_pin", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        ...
        //二维高速比较
        [DllImport("LTDMC.dll", EntryPoint = "dmc_hcmp_2d_set_enable", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern short dmc_hcmp_2d_set_enable(UInt16 CardNo, UInt16 hcmp, UInt16 cmp_enable);
        [DllImport("LTDMC.dll", EntryPoint = "dmc_hcmp_2d_get_enable", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern short dmc_hcmp_2d_get_enable(UInt16 CardNo, UInt16 hcmp, ref UInt16 cmp_enable);

        [DllImport("LTDMC.dll", EntryPoint = "dmc_hcmp_2d_set_config", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport("LTDMC.dll", EntryPoint = "dmc_hcmp_2d_get_config", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport("LTDMC.dll", EntryPoint = "dmc_hcmp_2d_add_point", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern short dmc_hcmp_2d_add_point(UInt16 CardNo, UInt16 hcmp, Int32 x_cmp_pos, Int32 y_cmp_pos);

        [DllImport("LTDMC.dll", EntryPoint = "dmc_hcmp_2d_get_current_state", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport("LTDMC.dll", EntryPoint = "dmc_hcmp_2d_clear_points", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern short dmc_hcmp_2d_clear_points(UInt16 CardNo, UInt16 hcmp);

        [DllImport("LTDMC.dll", EntryPoint = "dmc_hcmp_2d_force_output", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
	 ...
	 [DllImport("LTDMC.dll", EntryPoint = "dmc_read_rdy_pin", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
	  ...
	  //检测轴到位状态
       ...
       //DMC5800小线段前瞻函数
        ...
        //dmc_conti_set_da_follow_speed(WORD CardNo,WORD Crd,WORD da_no,double MaxVel,double MaxValue,double acc_offset,double dec_offset,double acc_time,double dec_time);
        ...
        public static extern short dmc_conti_set_da_follow_speed(UInt16 CardNo, UInt16 Crd, UInt16 da_no, double MaxVel, double MaxValue, double acc_offset, double dec_offset, double acc_time, double dec_time);
        [DllImport("LTDMC.dll", EntryPoint = "dmc_conti_set_da_enable", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern short dmc_conti_set_da_enable(UInt16 CardNo, UInt16 Crd, UInt16 enable,UInt16 channel,Int32 mark);//开启DA输出
        //
        [DllImport("LTDMC.dll", EntryPoint = "dmc_get_ad_input", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern short dmc_get_ad_input(UInt16 CardNo, UInt16 channel,ref  double Vout);//设置DA输出  
